...
def predict_load_shedding(input_file='saved_models/input_template_20.xlsx', 
                         model_dir='saved_models/upgrade_20',
                         output_file='predictions_20.csv',
                         n_features=6):  # 添加参数控制特征数量
    """
    预测负荷削减潜力
    """
    # 加载数据
    ...
    results = pd.DataFrame({
        ...
        'predicted_load_shift_kw': predictions.flatten()
    })
